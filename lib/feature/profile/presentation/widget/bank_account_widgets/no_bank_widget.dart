...
class NoBankAccountYet extends StatelessWidget {
  const NoBankAccountYet({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 3.h),
          Text(
            "You didn’t save any of your bank \naccounts yet.",
          ...
          SizedBox(height: 5.h),
          Text(
            "You can manage your saved bank accounts from \nhere once you add any",
